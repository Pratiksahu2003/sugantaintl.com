...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('influencer_profiles', function (Blueprint $table) {
            // Category and niche information
            $table->foreignId('primary_category_id')->nullable()->constrained('influencer_categories')->onDelete('set null');
            $table->json('secondary_categories')->nullable(); // Array of category IDs
            ...
            $table->json('availability')->nullable(); // When available for collaborations
    ...
    public function down(): void
    {
        Schema::table('influencer_profiles', function (Blueprint $table) {
            ...
            $table->dropColumn([
                'primary_category_id', 'secondary_categories', 'specializations',
                ...
                'has_manager', 'has_agency', 'availability', 'rate_per_campaign', 'currency', 'payment_methods',
